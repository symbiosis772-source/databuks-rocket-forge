  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: 'hidden' }}>
        ...
        <div className="vertical-text">DATABUKS</div>
      </div>
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          ...
          <p className="subtitle-line">
            Fast and Professional — Serving India & Worldwide
          </p>
        </div>
      ...
      <div className="scroll-sections">
        {[...Array(2)].map((_, i) => {
          ...
          const subtitles = {
            0: {
              line1: 'Build Websites, Apps, Software & MVPs',
              line2: 'Fast and Professional — Serving India & Worldwide'
            },
            1: {
              line1: 'Custom Solutions for Your Business',
              line2: 'AI Agents, Automation & Modern Technology'
            },
            2: {
              line1: 'From Idea to Launch in 1-1.5 Weeks',
              line2: 'Quality, Speed & Affordability Combined'
            }
          };

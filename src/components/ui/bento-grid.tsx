...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "bg-card [box-shadow:0_0_0_1px_hsl(var(--border)),0_2px_4px_hsl(var(--foreground)/0.05),0_12px_24px_hsl(var(--foreground)/0.05)]",
      "transform-gpu dark:[box-shadow:0_-20px_80px_-20px_hsl(var(--primary)/0.1)_inset]",
      className,
    )}
  >
    <div>{background}</div>

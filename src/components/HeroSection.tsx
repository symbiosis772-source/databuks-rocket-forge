...
const HeroSection = () => {
  const highlights = [
    { icon: Globe, label: "Custom Websites & Apps" },
    { icon: Rocket, label: "MVP Development for Startups" },
    { icon: Zap, label: "Fast 1–1.5 Month Delivery" },
    { icon: Workflow, label: "Automation & API Integrations" },
    { icon: Palette, label: "Modern UI/UX" },
    { icon: Code, label: "High-Quality Development" },
  ];

  const stats = [
    { value: "50+", label: "Projects Delivered" },
    { value: "1-1.5", label: "Months Avg. Delivery" },
      ...
      <div className="container mx-auto px-4 pt-32 pb-20 relative z-10">
        ...
        >
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="text-center p-4 rounded-xl bg-background/50 backdrop-blur-sm border border-border"
            >

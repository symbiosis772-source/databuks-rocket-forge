import { ArrowRight, Zap, Clock, DollarSign, Headphones } from "lucide-react";
      ...
      <div className="container mx-auto px-4 pt-32 pb-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          animationDelay: '0.1s'
            ...
            <span className="gradient-text">Website, App & Automation</span>{" "}
            Services.
          </h1>
          ...
          animationDelay: '0.3s'
            ...
            {highlights.map((item, index) => <div key={item.label} className="flex items-center gap-2 px-4 py-2 bg-background rounded-full shadow-sm border border-border">
        ...
        {/* Stats */}
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto animate-fade-up" style={{
        animationDelay: '0.5s'
      }}>
          {[{
          value: "50+",
